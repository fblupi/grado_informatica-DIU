    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav nav-tabs">
				...
				<ul class="nav navbar-nav nav-tabs navbar-right">
					<?php if(isset($_SESSION['login'])){ echo '<li role="presentation" class="nav-right" id="cerrarSesion"><a href="cerrarSesion.php">Cerrar sesión</a></li>'; echo '<li role="presentation" class="nav-right" id="micuenta"><a href="miCuenta.php">Mi Cuenta</a></li>'; }else{ echo '<li role="presentation" id="identificar" class="nav-right"><a href="inicioSesion.php">Indentifícate</a></li>';}
					?>
			</ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
