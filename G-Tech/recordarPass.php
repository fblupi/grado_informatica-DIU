...
<h1>Recordar contraseña<hr></h1>
<article>
	<form id="formularioRecordarPass" class="form-horizontal" method="POST" action="javascript:RecordarPass()" data-toggle="validator" role="form">
